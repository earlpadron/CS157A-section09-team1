    ...
    <% 
     String db = "CS157A"; //change to db name
        ...
        try {
            ...
            ResultSet rs = stmt.executeQuery("SELECT * FROM projecttables.roomservice;");
            int accID = 0;
            while (rs.next())
            {
            ...
            rs = stmt.executeQuery("SELECT * FROM projecttables.roomservice"); //change to schema name.table name
            %>
            <table>
      		<thead>
      			<tr>
            ...
            <div class="bcenter"><a href="roomServiceRequest.jsp"><button>Order Room Service</button></a></div>
            <br>
